...
export const Information = () => {
  return (
    <div className="grid min-h-screen grid-cols-12 col-span-10 pt-12 ">
      <Container tailClasses={"col-start-2 col-end-12 mt-1 mb-6"} shadowSize={"2xl"}>
        ...
        <div className="px-5 text-[#969696]">
          ...
          <div className="mx-8 my-3 text-sm ">
            ...
            <span className="font-bold ">Registration Phase:</span>
              During this phase the registration of the
              users (who are going to cast the vote) will be carried out.
            </li>
            <li className="my-1">
            <span className="font-bold ">Voting Phase:</span>
               After initialization of voting phase from the
              admin, user can cast the vote in voting section. The casting of
              vote can be simply done by clicking on “Cast your VOTE” button,
              after which transaction will be initiated and after confirming
              transaction the vote will be successfully casted. After the voting
              phase is over user will not be able to cast vote
            </li>
            <li className="my-1">
            <span className="font-bold ">Result Phase:</span>
               This is the final stage of the whole voting
              process during which the results of election will be displayed at
              “Result” section.
            </li>
            </ol>
          </div>
