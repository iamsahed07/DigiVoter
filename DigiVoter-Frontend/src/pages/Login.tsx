    ...
    <>
      <div className="flex items-center justify-center min-h-screen gap-5 bg-blue-300 ">
        ...
        <div className="md:w-[25%] w-[90vw]">
          <Container tailClasses={" px-4 rounded-lg my-2"} shadowSize={"lg"}>
          ...
          ${
           ...
           ${
            ...
            <form action="">
              ...
              />
              <button className="self-start my-2 text-sm text-[#437BD0] ">
                Forgot security PIN?
              </button>
              <button className="bg-[#116ACF] text-[#E7FFF2] py-2 mt-2 mb-5 rounded-md w-[100%] ">
                Login
              </button>
            </form>
          </Container>
