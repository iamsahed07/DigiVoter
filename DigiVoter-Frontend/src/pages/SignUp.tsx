...
export const SignUp = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen pt-12 bg-blue-300 ">
      <img 
      ...
      <Container tailClasses={"md:w-[25%] w-[90vw] px-4 rounded-lg my-2" } shadowSize={"lg"}>
